...
export const pricingfaqs: FAQ[] = [
  ...
  },
  {
    ...
    a: <>You'll have all the customization from the Plus plan along with:
    <ul class="list-inside list-disc text-sm">
      <li>Custom theme color for email</li>
      <li>Upload event logo to use in emails and on the bottom of our event</li>
      <li>Ability to remove some of our marketing and branding from emails</li>
    </ul>
     </>,
  },
	{
    q: "What additional fees are there with paid tickets?",
    a: <>You can see all fees on our <a href="/pricing">Pricing Page</a></>,
  },
	{
