  ...
  return (
    <div class="px-4 max-w-screen-lg w-full mx-auto mb-20">
      ...
      <p class="max-w-xl w-full text-center mx-auto mt-4">
        To keep pricing simple, we've created 3 simple plans. For enterprise
        use-cases, please contact us. Events is currently free for beta testers.
        If you have any questions they might be in our{" "}
